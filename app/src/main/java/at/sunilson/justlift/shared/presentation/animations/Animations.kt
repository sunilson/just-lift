...
object JustLiftAnimations {
    ...
    /**
     * Smooth spring for elegant, premium feel
     */
    ...
    /**
     * Spring for offset/position animations
     */
    ...
    /**
     * Elegant fade + scale entrance for cards and dialogs
     */
    fun glassEnter(
    ...
    /**
     * Elegant fade + scale exit for cards and dialogs
     */
    fun glassExit(
     ...
     * @param staggerDelay Delay between consecutive items
     */
    fun staggeredDelay(
        index: Int,
        baseDelay: Int = 100,
