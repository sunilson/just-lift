...
interface WorkoutHistoryDao {
    ...
    """)
    suspend fun getAllWithStats(userId: Int): List<WorkoutHistoryWithStats>
    ...
    @Query("SELECT DISTINCT exerciseName FROM workout_history WHERE exerciseName IS NOT NULL")
