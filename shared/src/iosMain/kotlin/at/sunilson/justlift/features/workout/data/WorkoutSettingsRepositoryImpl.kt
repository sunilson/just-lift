...
class WorkoutSettingsRepositoryImpl : WorkoutSettingsRepository {
    ...
    override fun settingsFlow(userId: Int): Flow<WorkoutSettings> = dataStore.data
        ...
        .map { prefs ->
            WorkoutSettings(
                ...
                fixedWeightMode = prefs[booleanPreferencesKey(userKey(KEY_FIXED_WEIGHT_MODE, userId))]
                    ?: WorkoutSettings().fixedWeightMode,
                fixedWeightKg = prefs[floatPreferencesKey(userKey(KEY_FIXED_WEIGHT_KG, userId))]
                    ?: WorkoutSettings().fixedWeightKg
            )
        }
    ...
    override suspend fun save(userId: Int, settings: WorkoutSettings) {
        dataStore.edit { prefs ->
            ...
            prefs[floatPreferencesKey(userKey(KEY_FIXED_WEIGHT_KG, userId))] = settings.fixedWeightKg
        }
    }
    ...
    override suspend fun getDifficultySettings(
        ...
        return DifficultySettings(
            repetitions = prefs[intPreferencesKey(diffKey(KEY_REPS_NAME, difficulty, userId))]
                ?: (prefs[intPreferencesKey(userKey(KEY_REPS_NAME, userId))]
                    ?: DifficultySettings().repetitions),
            eccentricPercentage = prefs[floatPreferencesKey(diffKey(KEY_ECCENTRIC_PERCENT_NAME, difficulty, userId))]
    ...
    override suspend fun saveDifficultySettings(
        ...
        dataStore.edit { prefs ->
            prefs[intPreferencesKey(diffKey(KEY_REPS_NAME, difficulty, userId))] = settings.repetitions
            prefs[floatPreferencesKey(diffKey(KEY_ECCENTRIC_PERCENT_NAME, difficulty, userId))] = settings.eccentricPercentage
        }
    }
    ...
    override suspend fun resetDifficultySettings(
        ...
        dataStore.edit { prefs ->
            prefs.remove(intPreferencesKey(diffKey(KEY_REPS_NAME, difficulty, userId)))
            prefs.remove(floatPreferencesKey(diffKey(KEY_ECCENTRIC_PERCENT_NAME, difficulty, userId)))
        }
    }
    ...
    override suspend fun getModeParameters(
        ...
        return ModeParameters(
            gain = prefs[floatPreferencesKey(modeKey("mode_gain", difficulty, userId))] ?: defaults.gain,
            capKg = prefs[floatPreferencesKey(modeKey("mode_cap", difficulty, userId))] ?: defaults.capKg
        )
    }
    ...
    override suspend fun saveModeParameters(
        ...
        dataStore.edit { prefs ->
            prefs[floatPreferencesKey(modeKey("mode_gain", difficulty, userId))] = params.gain
            prefs[floatPreferencesKey(modeKey("mode_cap", difficulty, userId))] = params.capKg
        }
    }
    ...
    override suspend fun resetModeParameters(
        ...
        dataStore.edit { prefs ->
            prefs.remove(floatPreferencesKey(modeKey("mode_gain", difficulty, userId)))
            prefs.remove(floatPreferencesKey(modeKey("mode_cap", difficulty, userId)))
        }
    }
    ...
    private companion object {
        ...
        private const val KEY_FIXED_WEIGHT_MODE = "fixed_weight_mode"
        private const val KEY_FIXED_WEIGHT_KG = "fixed_weight_kg"
